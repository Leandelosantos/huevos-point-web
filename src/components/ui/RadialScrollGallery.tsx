      ...
      >
        ...
        >
          <ul
            ...
            dir={direction}
            className={[
              'absolute left-1/2 m-0 list-none p-0 will-change-transform -translate-x-1/2 transition-opacity duration-500 ease-out',
              ...
              return (
                ...
                >
                  <div
                    ...
                    className={[
                      'block cursor-pointer rounded-xl text-left outline-none transition-all duration-500 ease-out will-change-transform',
