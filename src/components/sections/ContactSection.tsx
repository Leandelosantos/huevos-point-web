...
export function ContactSection() {
  ...
  useEffect(() => {
    ...
    if (checkCircleRef.current) {
      tl.fromTo(
        ...
        { scale: 0, opacity: 0 },
        {
          scale: 1,
          opacity: 1,
          duration: CONFIRMATION_CHECK_DURATION,
          ease: "back.out(1.7)",
        },
      );
    }
    ...
    if (checkPathRef.current) {
      ...
      tl.fromTo(
        ...
        {
          strokeDashoffset: 0,
          duration: CONFIRMATION_PATH_DURATION,
          ease: "power2.inOut",
        },
      );
    }
  ...
  const handleEggClick = () => {
    if (isBreakingRef.current || status === "submitting") return;
  ...
  const errorClasses =
    "mt-1 flex items-center gap-1 font-body text-xs text-error";
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 max-w-md font-body text-body text-[rgba(12,10,9,0.7)]">
              Completá el formulario y te contactamos para confirmar. También
            ...
            {orderItems.length > 0 && (
              <div className="mt-10 rounded-xl border border-[rgba(12,10,9,0.12)] bg-white/60 p-5">
                ...
                <div className="mt-3 border-t border-[rgba(12,10,9,0.12)] pt-3 flex items-center justify-between">
                  <span className="font-body text-sm font-bold text-bg-primary">
                    Total estimado
                  </span>
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="form-field">
                    ...
                    <input
                      ...
                      aria-describedby={
                        errors.customer_name ? "name-error" : undefined
                      }
                  ...
                  <div className="form-field">
                    ...
                    <input
                      ...
                      aria-describedby={
                        errors.customer_phone ? "phone-error" : undefined
                      }
                  ...
                  <div className="form-field">
                    ...
                    <input
                      ...
                      aria-describedby={
                        errors.customer_email ? "email-error" : undefined
                      }
                  ...
                  <div className="form-field">
                    ...
                    <textarea
                      ...
                      aria-describedby={
                        errors.notes ? "notes-error" : "notes-counter"
                      }
                      {...register("notes")}
                    />
                    <div className="mt-1 flex items-center justify-between">
                      ...
                      <span
                        id="notes-counter"
                        className="font-mono text-[10px] text-[rgba(12,10,9,0.4)]"
                      >
                  ...
                  {status === "error" && (
                    <div
                      className="form-field rounded-lg border border-error/20 bg-error/5 p-4"
                      role="alert"
                    >
                  ...
                  {/* Submit — huevo 3D */}
                  <div className="form-field pt-2 flex justify-center">
                    <MagneticButton
                      onClick={handleEggClick}
                      className="btn-egg text-brand-blue text-xs font-bold uppercase tracking-wider"
                    >
                      ...
                      <span
                        ref={eggLabelRef}
                        className="btn-egg__label flex flex-col items-center gap-0.5"
                      >
                        {status === "submitting" ? (
