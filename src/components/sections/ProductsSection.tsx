...
import { TomatoBottle } from "@/components/illustrations/TomatoBottle";
...
const GALLERY_PRODUCTS: GalleryProduct[] = [
  {
    id: "1",
    name: "Huevo N·3",
    category: "El mas chico",
    price: "",
    imageSrc: "images/products/n3.png",
  },
  {
    id: "2",
    name: "Huevo N·2",
    category: "Pequeño y poderoso",
    price: "",
    imageSrc: "/images/products/avocado.png",
  },
  {
    id: "3",
    name: "Huevo N·1",
    category: "El hermano del medio",
    price: "",
    imageSrc: "/images/products/mapleBlanco.png",
  },
  {
    id: "4",
    name: "Huevo Super",
    category: "El Huevo Estrella",
    price: "",
    imageSrc: "/images/products/super.png",
  },
  {
    id: "5",
    name: "Huevo Jumbo",
    category: "Doble Yema !",
    price: "",
    imageSrc: "/images/products/dobleYema.png",
  },
  {
    id: "6",
    name: "Huevo Color",
    category: "El distinto",
    price: "",
    imageSrc: "/images/products/color.png",
  },
];
...
export function ProductsSection() {
  ...
  useGSAP(
    () => {
      ...
      revealIllustration(tomatoRef.current, "top 92%", 0.25);
      ...
      scrollParallax(tomatoRef.current, -130, 130);
  ...
  return (
    ...
    >
      ...
      <div
        ref={wineRef}
        className="pointer-events-none absolute left-[3%] top-[50px] z-0 hidden w-[100px] select-none lg:block lg:w-[120px] xl:w-[140px]"
      >
      ...
      <div
        ref={oliveRef}
        className="pointer-events-none absolute right-[4%] top-[90px] z-0 hidden w-[80px] select-none lg:block lg:w-[95px] xl:w-[110px]"
      >
        <FloatingIllustration
          floatY={18}
          duration={5.2}
      ...
      <div
        ref={honeyRef}
        className="pointer-events-none absolute right-[2%] top-[40px] z-0 hidden w-[110px] select-none lg:block lg:w-[130px] xl:w-[150px]"
      >
      ...
      <div
        ref={nutsRef}
        className="pointer-events-none absolute left-[8%] top-[580px] z-0 hidden w-[90px] select-none lg:block lg:w-[106px] xl:w-[120px]"
      >
        <FloatingIllustration
          floatY={16}
          duration={4.6}
      ...
      <div
        ref={tomatoRef}
        className="pointer-events-none absolute right-[8%] top-[580px] z-0 hidden w-[90px] select-none lg:block lg:w-[106px] xl:w-[120px]"
      >
        <FloatingIllustration
          floatY={14}
          duration={4.8}
      ...
      <div
        ref={yerbaRef}
        className="pointer-events-none absolute bottom-[60px] right-[3%] z-0 hidden w-[100px] select-none lg:block lg:w-[116px] xl:w-[132px]"
      >
        <FloatingIllustration
          floatY={13}
          duration={4.4}
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 pt-24 text-center">
        <p className="font-mono text-2xl uppercase tracking-widest text-yolk">
          Catálogo de Huevos
        </p>
        <h2 className="mt-6 font-oswald-bold text-4xl sm:text-6xl lg:text-9xl text-text-primary">
          NUESTROS PRODUCTOS
        </h2>
        <p className="mt-4 mx-auto max-w-xl font-body text-xl sm:text-2xl lg:text-4xl text-text-secondary">
          Selección curada de huevos premium. Cada variedad elegida por su
          calidad excepcional, origen trazable y sabor incomparable.
        </p>
      </div>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <Badge
                    ...
                    style={{
                      backgroundColor: "rgba(2,12,30,0.75)",
                      color: "var(--color-text-secondary)",
                      border: "1px solid rgba(255,242,217,0.15)",
                    }}
                  >
                    {product.category}
                  </Badge>
                  ...
                  <div
                    className="mt-3 flex items-center gap-2 rounded-full py-1.5 px-3 w-fit text-xs font-body font-bold"
                    style={{
                      backgroundColor: "var(--color-yolk)",
      ...
      {!isMobile && (
        <RadialScrollGallery
          ...
          onItemSelect={(index) => {
            ...
            if (p)
              window.open(whatsappUrl(p.name), "_blank", "noopener,noreferrer");
          }}
        >
          {(hoveredIndex) =>
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col justify-between p-4">
                    <div className="flex items-start justify-between">
                      <Badge
                        variant="secondary"
                        className="text-[14px] backdrop-blur-sm"
                        style={{
                          backgroundColor: "rgba(2,12,30,0.75)",
                          color: "var(--color-text-secondary)",
                          border: "1px solid rgba(255,242,217,0.15)",
                      ...
                      <div
                        className={`flex h-6 w-6 items-center justify-center rounded-full transition-all duration-500 ${isActive ? "opacity-100 rotate-0" : "opacity-0 -rotate-45"}`}
                        style={{
                          backgroundColor: "var(--color-yolk)",
                          color: "var(--color-bg-primary)",
                        }}
                    ...
                    >
                      ...
                      <div
                        className={`mt-2 h-0.5 transition-all duration-500 ${isActive ? "w-full opacity-100" : "w-0 opacity-0"}`}
